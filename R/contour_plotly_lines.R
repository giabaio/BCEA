...
#' Add contour lines to a plotly contour or ceplane plot
#' 
#' @param plotly plotly object generated by calling function
#' @param he BCEA object of interest
#' @param delta_ce delta_ce object generated by calling function (long format)
#' @param graph_params Other graphical parameters
#' @param pt_cols vector of colors for the interventions
#'
#' @import plotly
#' @keywords internal
#' 
