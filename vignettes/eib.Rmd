...
In the `ggplot2` implementation, it is possible to modify the formatting of the numerical labels in the $x-$ and $y-$ axis using `ggplot2` failities, such as in the following code.
