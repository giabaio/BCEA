...
If we rerun the analysis we should see that this intervention is dropped.
...
Check that values no allowed for `r` are handled gracefully
_write unit tests for these..._
```{r}
r <- -0.005
CEriskav(bcea_smoke) <- r
