...
User-defined contour level can be provided. At the moment the base R and `ggplot2` arguments are different, corresponding to their different wrapped functions.

```{r}
contour(he, levels = c(0.2, 0.8))
contour(he, graph = "ggplot2", contour = list(breaks = c(50, 200)))
```
...
```{r}
contour(he, levels = c(0.2, 0.8))
contour(he, graph = "ggplot2", contour = list(breaks = c(0.005, 0.01, 0.02)))
```
