  ...
  {shiny::tagList(
    ...
    shiny::navbarPage(theme=shinythemes::shinytheme('united'),
                                           ...
                                           shiny::HTML(paste0(
                                             ...
                                             shiny::tags$ol(
                                               shiny::tags$li(shiny::HTML(paste0(
                                                 ...
                                                 shiny::tags$a(href="https://github.com/downloads/giabaio/BCEA/raw/refs/heads/dev/data/vaccine_parameters.csv","here",target="_blank"),";"))),
                                               shiny::tags$li(shiny::HTML(paste0(
                                             ...
                                             shiny::tags$a(href="https://github.com/downloads/giabaio/BCEA/raw/refs/heads/dev/data/vaccine_results.csv","here",target="_blank"),
                      ...
                      {shiny::tabPanel("2. Economic analysis",shiny::sidebarPanel(
                        ...
                        shiny::tags$br(),
                        shiny::actionButton("buttonsum","Run the analysis"),
