...
shiny::shinyUI(shiny::fluidPage(theme=shinythemes::shinytheme('united'),
                  shiny::titlePanel("BCEAweb"),
                  #                       headerPanel(HTML("<a href='http://www.ucl.ac.uk/' 
                  #                                        target='_blank'><img src = 'ucl.png' width = '100' 
                  #                                        alt='UCL logo' /></ href='http://www.mapigroup.com' 
                  #                                        target='_blank'><img src = 'mapi.png' width = '70' 
                  #                                        alt='Mapi group logo' /></a>")),
                    ...
                    shiny::tabsetPanel(
                      ...
                      shiny::tabPanel("Welcome",
                                     ...
                                     health economic evaluations, as described in the following graph.",
                                          ...
                                          shiny::tags$img(src='ModelScheme.png',width='55%',height='50%',
                                     ...
                                     being assessed in a .csv file. The order of the variables in this file ", 
                                          ...
                                          shiny::tags$img(src='PSA_data2.png',width='45%',height='40%',
                                                          ## This aligns the graphs ###
                                                          style="display: block; margin-left: auto; margin-right: auto;"),
                                          shiny::tags$br(),
                      ...
                      shiny::tabPanel("1. Check assumptions",
                                      shiny::sidebarPanel(
                                        ...
                                        shiny::selectInput("from","1. Import parameters simulation data from:",
                                                           choices=c("Spreadsheet","BUGS","R"),
                                                           selected="Spreadsheet"),
                                        
                                        # Panel data import from R (full Bayesian MCMC)
                                        shiny::conditionalPanel(condition="input.from=='R'",
                                                                shiny::fileInput('par_sims_R','Choose RDS File',
                                                                                 accept='.RDS')
                                        ),
                                        ...
                                        shiny::conditionalPanel(condition="input.from=='BUGS'",
                                                                ...
                                                                #shiny::actionButton("import_coda","Import using coda")
                                        ),
                                        
                                        # Upload from spreadsheet (CSV file)
                                      ...
                                      shiny::mainPanel(
                                        ...
                                        shiny::conditionalPanel(condition="input.from=='BUGS'",
                                                  ...
                                                  parameter")
                                                                  ...
                                                                  shiny::tabPanel("1.4. Effective sample size",
                                                                                  shiny::plotOutput('neff1',width="600px", height="600px")
                                                                  ),
                                                                  shiny::tabPanel("1.5. Autocorrelation",
                                                                                  shiny::plotOutput('acf1',width="600px", height="600px")
                                                                  )
                                                                )
                                        ),
                      ...
                      #BCEA tab#
                      ##########
                      shiny::tabPanel("2. Economic analysis",
                                      shiny::sidebarPanel(
                                        shiny::tags$div(
                                          shiny::HTML(paste0(
                                            "In this panel, the user can upload the simulation data for the economic output. These are
                                       defined in terms of a vector of simulations for the effectiveness variable and a vector of
                                       simulations for the cost variable, for each of the interventions being assessed.",
                                            shiny::tags$br(),shiny::tags$br(),
                                            "The user can also specify the range and default value for the willingness-to-pay parameter,
                                       as well as the labels associated with each interventions. Clicking the ",
                                        ...
                                        shiny::selectInput("data","1. Import the (e,c) data from:",
                                                           choices=c("Spreadsheet","R","BUGS","Parameter simulations (from Check assumptions)"),
                                                           selected="Spreadsheet"),
                                        ...
                                        shiny::conditionalPanel(condition="input.data=='Parameter simulations (from Check assumptions)'",
                                        ...
                                        shiny::tabsetPanel(
                                          ...
                                          shiny::tabPanel("2.2. Cost-Effectiveness plane",
                                                          shiny::fluidRow( shiny::column(8,
                                                                                         shiny::plotOutput('cep',width="600px", height="600px" )),
                                                                           shiny::column(4,
                                                                                         shiny::uiOutput("other_CEA"))
                                                          )
                                          ),
                                          ...
                                          shiny::tabPanel("2.4 Cost-Effectiveness Efficiency Frontier",
                                                          shiny::fluidRow(
                                                            shiny::column(7,
                                                                          shiny::mainPanel(
                                                                            shiny::plotOutput('ceef', width = "600px",height = "600px"))
                                                            ),
                                                            shiny::column(10,
                      ...
                      shiny::tabPanel("3. Probabilistic Sensitivity Analysis",
                                      ...
                                      shiny::tabsetPanel(
                                        ...
                                        ### FOR NOW Risk Aversion & Mixed Strategy NOT INCLUDED
                                        #                                    tabPanel("3.4. Risk Aversion",
                                        #                                             sidebarPanel(    
                                        #                                               numericInput("r1",label = "Choose values for the risk parameter r",
                                        #                                                            value = 0.000001, min = 0, max = 1,  step = 0.00000001),
                                        #                                               numericInput("r2",label = " ", value = 0.0005, min = 0, max = 1,  step = 0.00000001),
                                        #                                               numericInput("r3",label = " ", value = 0.02, min = 0, max = 1,  step = 0.00000001),
                                        #                                               numericInput("r4",label = " ", value = 0.035, min = 0, max = 1,  step = 0.00000001),
                                        #                                               actionButton("buttonplot","Run"),
                                        #                                               width = '2'   
                                        #                                             ),
                                        #                                             p(h5(strong("explanation, use: Cost-effectiveness analysis 
                                        #                                   including a parameter of risk aversion, since standard analysis assumes
                                        #                                   risk-neutrallity"))),                
                                        #                                             mainPanel(
                                        #                                               plotOutput('aver', width = "600px", height = "600px") 
                                        #                                             )
                                        #                                    ),
                                        #                                    tabPanel("3.5. Mixed Strategies",
                                        #                                             sidebarPanel(                             
                                        #                                               numericInput("q0",label = "Market shares for standard treatment ", value = 0.5, min = 0, max = 1,  step = 0.001),
                                        #                                               p(tags$i(h6("Automatically market shares for new treatemnt are 1 minus this"))),
                                        #                                               width = '3'
                                        #                                             ),
                                        #                                             p(h5(strong("explanation and use: s used to performed the analysis of
                                        #                                                     the mixed strategy.we need to define the vector of market shares for all
                                        #                                                     the treatment in analysis. . The result of the analysis will be displayed graphically below. "))),
                                        #                                             mainPanel(
                                        #                                               plotOutput('mixed',width = "600px", height = "600px")
                                        #                                             )
                                        #                                    )
                                      )
                      ),
